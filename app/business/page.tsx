  ...
  return (
    <SubPageShell number="03" english="OUR BUSINESS" title="地域の暮らしを、支え続ける。" lead="医療・介護を通じて、住み慣れた地域での安心をつくります。">
      ...
      <section className="service-detail">
        ...
        <article><div><img src="/hph-support.jpg" alt="暮らしのお困りごとに寄り添うHPHスタッフ" /></div><section><span>03</span><p>DAILY LIFE SUPPORT</p><h2>生活サポート事業</h2><p>通院同行、お部屋の片付け、話し相手など、介護・医療保険の対象外となる日常のお困りごとを幅広くサポート。兵庫県神戸市全域で、ご希望や生活状況に合わせたサービスを提供します。</p></section></article>
      </section>
